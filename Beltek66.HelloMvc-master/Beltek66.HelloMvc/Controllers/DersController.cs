...
namespace Beltek66.HelloMvc.Controllers
{
    public class DersController : Controller
    {
        ...
        {
            ViewData["OgretmenId"] = new SelectList(_context.Ogretmen, "Id", "Ad");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DersAdi,OgretmenId")] Ders ders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DersAdi,OgretmenId")] Ders ders)
        {
            if (id != ders.Id)
            {
                return NotFound();
